...
class InstallationService implements InstallerInterface
{
    ...
    {
        $this->logger->debug("CustomerInteractionBundle -> Install()");
    ...
    {
        $this->logger->debug("CustomerInteractionBundle -> Update()");
    ...
    {
        $this->logger->debug("CustomerInteractionBundle -> Uninstall()");
